...
void set_example_object_frames(geometry_msgs::PoseStamped &object_poseStamped,
    ...
    object_poseStamped.pose.position.y = -0.3400;
    // object_poseStamped.pose.position.z =  0.7921; //-0.125; //pose w/rt world frame

    object_poseStamped.pose.position.z =  0.82;
    ...
    object_dropoff_poseStamped.pose.position.y = -0.34;
    object_dropoff_poseStamped.pose.position.z = 0.5;
}
...
void   dropoff_object(geometry_msgs::PoseStamped object_dropoff_poseStamped) {
    ...
    object_grabber_goal.grasp_option = object_grabber::object_grabberGoal::GRASP_FROM_SIDE;  // From side
    object_grabber_goal.speed_factor = 1.0;
